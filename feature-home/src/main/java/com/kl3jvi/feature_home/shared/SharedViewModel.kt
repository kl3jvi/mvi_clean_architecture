...
class SharedViewModel @Inject constructor(
    ...
    val uiRestaurantState: StateFlow<RestaurantUiState> =
        sortOption.flatMapLatest { sortOption ->
            repository.getRestaurants().asResult().map { result ->
                when (result) {
            ...
            /*Keeps the upstream flow active for 5 seconds more after the disappearance of the last collector.
